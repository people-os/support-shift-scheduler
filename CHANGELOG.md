...
* Include new env vars in .env.dist [Carlo Miguel F. Cruz]
* Load DevOps agent emails from Google Sheets [Carlo Miguel F. Cruz]

# v7.0.0
## (2026-09-23)

* Adapt scheduler for the release of support v2 [AlidaOdendaal]

# v6.1.2
## (2026-06-15)

* Deduplicate DevOps weekend calendar event insertion [Carlo Miguel F. Cruz]
* Simplify past DevOps weekend schedule fetch [Carlo Miguel F. Cruz]
* Rename helper script and add npm run script [Carlo Miguel F. Cruz]
* Update VO schedule script: add dry-run mode, update auth, and add missing dependency [Carlo Miguel F. Cruz]
...
* Shorten balena-io support day to usually end at 01:00 UK [AlidaOdendaal]
...
* Start the balena-io support day at 08:00 UK [AlidaOdendaal]

# v6.0.3
## (2025-10-07)

* Add otaviojacobi to the DevOps rotation. [Carlo Miguel F. Cruz]

# v6.0.2
## (2025-05-27)

* Split off 2025 logs to prevent GSheet from becoming too big [AlidaOdendaal]
...
* Extend scheduler to allow multiple shifts per agent per day [AlidaOdendaal]
